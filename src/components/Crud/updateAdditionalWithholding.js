...
const updateAdditionalWithholding = async (newAdditionalWithholding) => {
    console.log("Inside updateAddtionalWithholding")
    try {
        ...
        await updateDoc(userDocumentRef, { additionalWithholding: newAdditionalWithholding });
...
export default updateAdditionalWithholding;
