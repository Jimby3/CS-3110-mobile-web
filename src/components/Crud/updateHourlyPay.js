...
const updateHourlyPay = async (newHourlyPay) => {
    console.log("Inside updateHourlyPay")
    try {
        ...
        await updateDoc(userDocumentRef, { hourlyPay: newHourlyPay});
...
export default updateHourlyPay;
