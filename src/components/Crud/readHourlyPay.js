...
const readHourlyPay = async () => {
    console.log("Inside readHourlyPay");
    try {
        ...
        if (userDocSnapshot.exists()) {
            ...
            return userData.hourlyPay; // Assuming the field is named 'hourlyPay' in the document
        } else {
