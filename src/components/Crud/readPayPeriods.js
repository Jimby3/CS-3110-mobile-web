...
const readPayPeriods = async () => {
    console.log("Inside readPayPeriods");
    try {
        ...
        if (userDocSnapshot.exists()) {
            ...
            return userData.payPeriods; // Assuming the field is named 'payPeriods' in the document
        } else {
            throw new Error('User document does not exist.');
        }
    } catch (error) {
        console.error('Error reading pay periods:', error);
        throw error;
    }
};
