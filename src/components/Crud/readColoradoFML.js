...
const readColoradoFML = async () => {
    console.log("Inside readColoradoFML");
    try {
        ...
        if (userDocSnapshot.exists()) {
            ...
            return userData.coloradoFML; // Assuming the field is named 'coloradoFML' in the document
        } else {
            throw new Error('User document does not exist.');
        }
    } catch (error) {
        console.error('Error reading Colorado FML:', error);
        throw error;
    }
};

export default readColoradoFML;
