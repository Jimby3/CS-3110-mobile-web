...
const readAdditionalWithholding = async () => {
    console.log("Inside readAdditionalWithholding");
    try {
        ...
        if (userDocSnapshot.exists()) {
            ...
            return userData.additionalWithholding; // Assuming the field is named 'additionalWithholding' in the document
        } else {
            throw new Error('User document does not exist.');
        }
    } catch (error) {
        console.error('Error reading additional withholding:', error);
        throw error;
    }
};

export default readAdditionalWithholding;
