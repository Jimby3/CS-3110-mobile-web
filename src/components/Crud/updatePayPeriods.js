...
const updatePayPeriods = async (newPayPeriod) => {
    console.log("Inside updatePayPeriods")
    try {
        ...
        await updateDoc(userDocumentRef, { payPeriods: newPayPeriod });
...
export default updatePayPeriods;
